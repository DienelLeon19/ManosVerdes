 ...
 * @author Leonardo
 */
public class FrameArteYManualidades extends javax.swing.JFrame {

    private FrameReutilizayCrea padre;
    /**
     * Creates new form FrameArteYManualidades
     */
    public FrameArteYManualidades() {
        initComponents();
    }
    
     public FrameArteYManualidades(FrameReutilizayCrea padre) {
        this.padre = padre;
        initComponents();
    ...
    private void initComponents() {
        ...
        lbl_Info.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Recursos/Info7E.png"))); // NOI18N
        jPanel1.add(lbl_Info, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 20, -1, -1));

        lbl_Img1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Recursos/Img13.jpeg"))); // NOI18N
        jPanel1.add(lbl_Img1, new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 380, -1, -1));

        lbl_Img2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Recursos/Img14.jpeg"))); // NOI18N
        jPanel1.add(lbl_Img2, new org.netbeans.lib.awtextra.AbsoluteConstraints(710, 390, -1, -1));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrameArteYManualidades.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
